...
<body>
<form method="post" action="<?php echo site_url("Welcome/booking");?>" id="checkbox1">

<table style="margin-left: 240px; margin-top: 20px;" width="55%" >
<tr>
	<td>ชื่อ:<br> 
		<input class="textbox"  type="text" name="fname"  placeholder="ชื่อ.." required="true">
		<br>นามสกุล:<br>
		<input class="textbox" type="text" name="lname"  placeholder="นามสกุล.." required="true"> 
		<br>เบอร์โทร:<br> 
		<input class="textbox" type="text" name="phone"  placeholder="เบอร์โทร.." required="true"> 
		<br>ที่อยู่:<br> 
		<input class="textbox" type="text" name="address"  placeholder="ที่อยู่.." required="true"> 
		<br>ต้นทาง:<br>
		<input class="textbox" type="text" name="from"  placeholder="ต้นทาง.." required="true"> 
		<br>ปลายทาง:<br> 
		<input class="textbox" type="text" name="to"  placeholder="ปลายทาง.." required="true"> 
		<br><br>
    <button class="button" onclick="goBack()" ><span>ย้อนกลับ</span></button>
    <button class="button" style="vertical-align:middle"><span>จอง  </span></button>
	</td>
	<td>
<script> 
function goBack() {
